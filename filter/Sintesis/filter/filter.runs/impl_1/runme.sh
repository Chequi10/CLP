...
HD_PWD='/home/ezequiel/CLP/filter/Sintesis/filter/filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_RI.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_RI.tcl -notrace
