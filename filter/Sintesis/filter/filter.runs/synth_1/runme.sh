...
HD_PWD='/home/ezequiel/CLP/filter/Sintesis/filter/filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_RI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_RI.tcl
