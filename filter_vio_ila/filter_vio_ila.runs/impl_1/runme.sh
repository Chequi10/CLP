...
HD_PWD='/home/ezequiel/CLP/filter_vio_ila/filter_vio_ila.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_RI_vio_ila.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_RI_vio_ila.tcl -notrace
