...
HD_PWD='/home/ezequiel/CLP/filter_vio_ila/filter_vio_ila.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_RI_vio_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_RI_vio_ila.tcl
